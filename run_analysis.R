...
names(auxtidydata)<-gsub("MeanFreq", "MeanFrequency", names(auxtidydata), ignore.case = TRUE)
...
#write txt
data.table::fwrite(x = tidydata, file = "tidydata.txt", quote = FALSE,row.names=FALSE)
